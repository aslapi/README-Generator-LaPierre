...
const userQuestions = ["What is the title of your application?", "What is the description of your application?", "Would you like to create a Table of Contents?",
    ...
    "Provide instructions for the user on how to use your application and provide screenshots if necessary.", "Who contributed, if anyone, to this project?",
    "What license was used for this project?", "Does this application need additional testing?", "Enter the link to your github profile", "What is your email address?"];
...
const questions = [
    ...
    // Took out the yes/no option for adding a ToC
    // {
    //     type: 'input',
